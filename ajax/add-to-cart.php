...
$query_ins = "insert into tbl_cart(user_id, p_id, p_name, p_color, p_size, p_price, p_actual_price, p_gst, p_image, p_quantity, no_of_item, weight, unit, sku) values('$user_id', '$p_id', '$p_name', '$p_color', '$p_size', '$p_price', '$p_actual_price', '$p_gst', '$p_image', '$p_qty', '$p_total_item', '$p_weight', '$p_unit', '$p_full_sku')";
